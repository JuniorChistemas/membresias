            ...
            <div class="table-container">
                <Table class="table-responsive">
                    ...
                    <TableBody class="table-body">
                        <TableRow v-for="local in props.locals" :key="local.id" class="table-row">
                            <TableCell class="cell-id">{{ local.id }}</TableCell>
                            <TableCell class="cell-data">{{ local.name }}</TableCell>
                            <TableCell class="cell-data">{{ local.address || 'Sin dirección' }}</TableCell>
                            <TableCell>
                                <span
                                    v-if="local.status === true"
...
import { LocalResource } from '../interfaces/Local';
...
const emit = defineEmits<{
    ...
    (e: 'open-modal-edit', id_local: number): void;
